...
FileAppend, ACCOUNTING`, Sales Export`, %timeNow%`, %timeEnd%`n, C:\PMC\Log\Sales Export.txt
Sleep, 500
MsgBox, 0, , Sales Export Selesai !
pebdate := Clipboard  ; input week 3
Sleep, 500  ; input week 3
...
Macro2:
Run, D:\PMC\Scenarios\1. Accounting\8. Sales Export\Support Files\1. WEEKLY REPORT .xls, D:\PMC\Scenarios\1. Accounting\8. Sales Export\Support Files
Sleep, 2000
...
Sleep, 333
Sleep, 1000
Run, D:\PMC\Scenarios\1. Accounting\8. Sales Export\Support Files\2. Rekap Sales Export.xls, D:\PMC\Scenarios\1. Accounting\8. Sales Export\Support Files\
WinMaximize, 2. Rekap Sales Export.xls  [Compatibility Mode] - Excel
Sleep, 333
Sleep, 1000
Run, D:\PMC\Scenarios\1. Accounting\8. Sales Export\Support Files\3. Unit Price.xlsx, D:\PMC\Scenarios\1. Accounting\8. Sales Export\Support Files\
WinMaximize, 3. Unit Price.xlsx - Excel
Sleep, 333
Sleep, 1000
Run, D:\PMC\Scenarios\1. Accounting\8. Sales Export\Support Files\4. SALES REPORT - 1.xlsx, D:\PMC\Scenarios\1. Accounting\8. Sales Export\Support Files\
...
SetKeyDelay, %CurrentKeyDelay%
Sleep, 1000
Run, D:\PMC\Scenarios\1. Accounting\8. Sales Export\Support Files\5. SALES REPORT.xlsx, D:\PMC\Scenarios\1. Accounting\8. Sales Export\Support Files\
...
Sleep, 333
Sleep, 500  ; Copy paste jumlah qty dan amount
...
Send, {Control Down}{v}{Control Up}  ; Copy paste jumlah qty dan amount
Sleep, 2000  ; Copy paste jumlah qty dan amount
...
SetKeyDelay, %CurrentKeyDelay%
Sleep, 1000  ; make pivot tabel
CurrentKeyDelay := A_KeyDelay
SetKeyDelay, 300
SendEvent, {Alt}{J}{T}{L}  ; make pivot tabel
SetKeyDelay, %CurrentKeyDelay%
Sleep, 1000  ; make pivot tabel
CurrentKeyDelay := A_KeyDelay
SetKeyDelay, 300
...
SetKeyDelay, %CurrentKeyDelay%
Sleep, 5000  ; make pivot tabel
Click, 662, 422 Left, 1
Sleep, 10
Sleep, 2000
Send, {F5}  ; copy SKE Kuning
Sleep, 300
Sleep, 500  ; copy SKE Kuning
CurrentKeyDelay := A_KeyDelay
SetKeyDelay, 300
SendEvent, {A}{5}{Enter}  ; copy SKE Kuning
SetKeyDelay, %CurrentKeyDelay%
Sleep, 1000  ; copy SKE Kuning
CurrentKeyDelay := A_KeyDelay
SetKeyDelay, 300
...
Sleep, 333
Sleep, 500  ; Input tabel JKC biru
...
CurrentKeyDelay := A_KeyDelay
SetKeyDelay, 300
SendEvent, {Control Down}{Shift Down}{Right}{Down}{Shift Up}{Control Up}  ; Input tabel JKC biru
SetKeyDelay, %CurrentKeyDelay%
Sleep, 500  ; Input tabel JKC biru
...
monthlyReport:
Sleep, 500
WinActivate, 5. SALES REPORT.xlsx - Excel (Product Activation Failed)
Sleep, 333
Sleep, 500
CurrentKeyDelay := A_KeyDelay
SetKeyDelay, 300
...
SetKeyDelay, %CurrentKeyDelay%
Sleep, 500  ; Copy paste total qty dan amount
...
CurrentKeyDelay := A_KeyDelay
SetKeyDelay, 300
SendEvent, {Control Down}{Down}{Down}{Control Up}  ; Copy paste total qty dan amount
SetKeyDelay, %CurrentKeyDelay%
Sleep, 500  ; Copy paste total qty dan amount
...
CurrentKeyDelay := A_KeyDelay
SetKeyDelay, 300
SendEvent, {F}{1}{1}{Enter}  ; Copy paste total qty dan amount
SetKeyDelay, %CurrentKeyDelay%
Sleep, 500  ; Copy paste total qty dan amount
CurrentKeyDelay := A_KeyDelay
SetKeyDelay, 300
SendEvent, {Control Down}{Down}{Down}{Down}{Control Up}  ; Copy paste total qty dan amount
SetKeyDelay, %CurrentKeyDelay%
Sleep, 500  ; Copy paste total qty dan amount
Send, {Control Down}{c}{Control Up}  ; Copy paste total qty dan amount
Sleep, 300
